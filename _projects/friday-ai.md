...
categories: projects
status: archived
excerpt: "A modular, skill-based AI assistant with MCP tooling and a FastAPI backend."
---
...
- This repo's structure was too messy. After gaining experience in software engineering, I realized I should create a cleaner structure.
- I focused too much on tools and thinking too big. The two weeks I spent on this project were mostly dedicated to tools rather than orchestration, which **deviated** from the original goal.
